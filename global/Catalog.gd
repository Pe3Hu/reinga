...
const string_to_tooltip = {
	...
	"child": Bozo.Tooltip.,
	"parent": Bozo.Tooltip.,
	"neighbor": Bozo.Tooltip.,
	"ballet": Bozo.Tooltip.,
	"puppetry": Bozo.Tooltip.,
	"opera": Bozo.Tooltip.,
	"trait": Bozo.Tooltip.,
	"fear": Bozo.Tooltip.,
	"repose": Bozo.Tooltip.,
	...
	"guilt": Bozo.Tooltip.,
	"catena": Bozo.Tooltip.,
	"torture": Bozo.Tooltip.,
	"permanent": Bozo.Tooltip.,
	"transient": Bozo.Tooltip.,
	"eclipse": Bozo.Tooltip.,
	"guild": Bozo.Tooltip.,
	"brotherhood": Bozo.Tooltip.BR,
	#"": Bozo.Tooltip.,
}

var tooltip_to_template = {
	Bozo.Tooltip.SIN: "[i]Transient[/i] %s [ghost][meta essense]Essense[/meta][/ghost]",
	Bozo.Tooltip.AMBER: "[i]Permanent[/i] %s [ghost][meta essense]Essense[/meta][/ghost]",
	...
	Bozo.Tooltip.BANK: "Stores ",
	Bozo.Tooltip.MARKET: "example description",
	Bozo.Tooltip.CONTRIBUTION: "example description",
	Bozo.Tooltip.PLATFORM: "example description",
	Bozo.Tooltip.SPECTACLE: "example description for %s",
	Bozo.Tooltip.OMEN: "example description for %s",
}
